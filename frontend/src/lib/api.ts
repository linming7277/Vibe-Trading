...
export interface ValueUniverseAnalysis { universe_id: string; universe_status: string; data_as_of: string; total: number; state_counts: Record<string, number>; monitored: number; model_state: ValueCompanyAnalysis["model_state"]; analysis_version: string; items: ValueCompanyAnalysis[]; }
