...
mcp = FastMCP("恒值投资", version=APP_VERSION)
...
def add_goal_evidence(
    ...
    Args:
        ...
        run_id: Research run id. It verifies evidence only when the run directory exists.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="恒值投资 MCP 服务")
    parser.add_argument(
        "--transport",
