...
_INSTALL_HINTS: dict[str, str] = {
    ...
    "feishu_supervisor": "pip install 'vibe-trading-ai[feishu]'",
    "feishu_risk": "pip install 'vibe-trading-ai[feishu]'",
    "feishu_valuation": "pip install 'vibe-trading-ai[feishu]'",
    "feishu_macro_policy": "pip install 'vibe-trading-ai[feishu]'",
...
_AVAILABILITY_FLAGS: dict[str, tuple[str, ...]] = {
    ...
    "feishu_supervisor": ("FEISHU_AVAILABLE",),
    "feishu_risk": ("FEISHU_AVAILABLE",),
    "feishu_valuation": ("FEISHU_AVAILABLE",),
    "feishu_macro_policy": ("FEISHU_AVAILABLE",),
