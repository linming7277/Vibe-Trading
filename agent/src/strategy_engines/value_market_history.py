...
class ValueMarketHistoryService:
    ...
    def refresh(
        ...
        *,
        ...
        coverage = len(covered.intersection(universe)) / len(universe) if universe else 0.0
        if universe and coverage < MIN_COVERAGE:
            return {
                "status": "partial", "coverage": coverage, "covered": len(covered.intersection(universe)),
        ...
        return {
            ...
            "covered": len(covered.intersection(universe)), "total": len(universe),
