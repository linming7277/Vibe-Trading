...
from .industry_catalog import TdxResearchIndustryCatalog
from .models import TDX_TERMINAL_INDUSTRY_SOURCE, business_text, stable_hash
    ...
    def profiles(self, industry_code: str) -> list[dict[str, Any]]:
        ...
        for code in member_codes:
            ...
            fields = {
                ...
                "main_business": str(fundamental.get("main_business") or _first(merged, ("MainBusiness", "ZYYW"))).strip(),
                "company_description": _first(merged, ("CompanyDescription", "CompanyIntroduction", "CompanyIntro", "GSJJ")),
