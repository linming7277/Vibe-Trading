#!/usr/bin/env python3
"""Idempotently install Company Thesis Review V1 in research.db."""
...
def inventory(db_path: str) -> dict[str, object]:
    with sqlite3.connect(db_path) as conn:
        ...
        count = conn.execute("SELECT COUNT(*) FROM company_thesis_reviews").fetchone()[0] if exists else 0
        ...
        return {
            ...
            "company_thesis_reviews_exists": exists,
            "company_thesis_reviews_count": count,
        }


def main() -> int:
    parser = argparse.ArgumentParser()
    parser.add_argument("--apply", action="store_true", help="create review table and indexes")
